...
export default function DeveloperPage({ isDarkMode, toggleTheme }) {
  ...
  return (
    ...
    >
      ...
      <section className="container mx-auto px-6 py-10 text-center relative">
        <div className="max-w-4xl mx-auto">
          <div
            className={`relative rounded-3xl p-8 mb-8 shadow-2xl ${
              isDarkMode
          ...
          >
            ...
            <div className="absolute top-0 left-0 w-20 h-20 bg-blue-600/10 rounded-full blur-xl"></div>
            <div className="absolute bottom-0 right-0 w-24 h-24 bg-indigo-600/10 rounded-full blur-xl"></div>

            <div className="relative z-10">
              <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                {/* Image Section - Left */}
                <div className="flex-shrink-0">
                  <div className="relative w-40 h-48 sm:w-48 sm:h-60 lg:w-60 lg:h-80 mx-auto rounded-full overflow-hidden border-4 border-cyan-500 shadow-2xl transform hover:scale-105 transition-transform duration-300">
                    <img
                ...
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <p className="text-lg lg:text-xl mb-2 bg-gradient-to-r from-blue-400 to-indigo-500 bg-clip-text text-transparent font-bold">
                    INFORMATION TECHNOLOGY
                  </p>
                  <p className="text-base lg:text-lg font-semibold text-cyan-400 mb-6">
                    Full Stack Web Developer
                  </p>

                  <div className="flex justify-center lg:justify-start gap-4 lg:gap-6 mt-6 text-sm flex-wrap">
                    <span
                    ...
                    >
                      <Mail className="w-4 h-4" /> harshmanmode79@gmail.com
                    </span>
                    <span
                      className={`flex items-center gap-2 px-4 py-3 rounded-full shadow-lg transition-all hover:scale-105 ${
                        isDarkMode
                    ...
                    >
                      <Phone className="w-4 h-4" /> +91-8305721431
                    </span>
                  </div>
                </div>
              </div>
      ...
      <section className="container mx-auto px-10 lg:px-16 py-12">
        <h3 className="text-3xl font-bold mb-8 flex items-center gap-3 bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent">
          <GraduationCap className="w-7 h-7" /> Education
        </h3>
        <div
          className={`max-w-4xl mx-auto rounded-3xl p-8 border-2 shadow-2xl transition-all hover:shadow-xl ${
            isDarkMode
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div
              className={`p-4 rounded-2xl ${
                isDarkMode ? "bg-slate-800/50" : "bg-emerald-100"
              }`}
            >
              <img
            ...
            <div className="flex-1 text-left">
              ...
              <div className="space-y-2">
                ...
                <p className="text-cyan-400 font-medium">Sept 2024- Jun 2028</p>
                <p className="text-pink-400 font-medium">CGPA: 8.2/10</p>
      ...
      <section className="container mx-auto px-10 lg:px-16 py-12">
        <h3 className="text-3xl font-bold mb-8 flex items-center gap-3 bg-gradient-to-r from-yellow-400 to-amber-500 bg-clip-text text-transparent">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {[
            ...
            <div
              key={i}
              className={`p-6 rounded-2xl border-2 shadow-lg transition-all hover:scale-105 ${
                isDarkMode
      ...
      <section className="container mx-auto px-10 lg:px-16 py-12">
        <h3 className="text-3xl font-bold mb-8 flex items-center gap-3 bg-gradient-to-r from-blue-400 to-cyan-500 bg-clip-text text-transparent">
          <Briefcase className="w-7 h-7" /> Internship
        </h3>
        <div className="max-w-4xl mx-auto">
          {internships.map((intern, i) => (
            <div
              key={i}
              className={`rounded-3xl p-8 border-2 shadow-xl transition-all hover:scale-105 ${
                isDarkMode
            ...
            >
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div
                  className={`p-4 rounded-2xl ${
                    isDarkMode ? "bg-slate-800/50" : "bg-blue-100"
                  }`}
                >
                  <img
                    src={intern.img}
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-cyan-400 text-lg mb-4">{intern.time}</p>
                  <p
                    className={`text-lg ${
                      isDarkMode ? "text-gray-300" : "text-gray-700"
                    }`}
      ...
      <section className="container mx-auto px-10 lg:px-16 py-12">
        <h3 className="text-3xl font-bold mb-8 flex items-center gap-3 bg-gradient-to-r from-purple-400 to-indigo-500 bg-clip-text text-transparent">
          <BookOpen className="w-7 h-7" /> Under the Guidance of
        </h3>
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* First Mentor Box */}
          <div
            className={`rounded-3xl p-8 border-2 shadow-2xl transition-all hover:scale-105 ${
              isDarkMode
            ...
            <div className="flex flex-col items-center gap-6 text-center">
              <div className="relative">
                ...
                <img
                  ...
                  className="w-32 h-32 rounded-full object-cover border-4 border-purple-500/50 relative z-10"
                />
              </div>
              <div>
                <h4 className="font-bold text-2xl text-purple-400 mb-2">
            ...
            <div className="flex flex-col items-center gap-6 text-center">
              <div className="relative">
                ...
                <img
                  ...
                  alt="Atul Chauhan"
                  className="w-32 h-32 rounded-full object-cover border-4 border-indigo-500/50 relative z-10"
                />
              </div>
              <div>
                <h4 className="font-bold text-2xl text-indigo-400 mb-2">
                  Atul Chauhan
                </h4>
                <p
                  className={`text-lg ${
                ...
                >
                  Programmer, Madhav Institute of Technology and Science - DU
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="container mx-auto px-10 lg:px-16 py-12">
        <div
          className={`max-w-4xl mx-auto rounded-3xl p-8 border-2 shadow-2xl ${
            isDarkMode
              ? "bg-gradient-to-br from-slate-900/80 to-indigo-900/20 border-indigo-600/20"
              : "bg-gradient-to-br from-white to-indigo-50 border-indigo-200"
          }`}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="text-center">
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r ${stat.color} mb-3 shadow-lg`}
                >
