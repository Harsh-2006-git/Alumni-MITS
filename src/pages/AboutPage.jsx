...
export default function AboutPage() {
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 mt-6 sm:mt-8 lg:mt-12">
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                ...
                <h4 className="text-xl sm:text-2xl font-bold text-cyan-400">
                  2024
                </h4>
              </div>
              <p
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              ...
              <h4 className="text-lg sm:text-xl lg:text-2xl font-bold text-purple-400">
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              ...
              <h4 className="text-lg sm:text-xl lg:text-2xl font-bold text-indigo-400">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 mt-6 sm:mt-8">
            {section.content.initiatives.map((initiative, index) => (
              ...
              >
                ...
                <h4 className="text-base sm:text-lg lg:text-xl font-bold text-emerald-400 mb-2">
                  {initiative.title}
                </h4>
                <p
    ...
    if (activeSection === "leadership") {
      return (
        <div className="space-y-8 sm:space-y-10">
          ...
          <div>
            <h4 className="text-lg sm:text-xl lg:text-2xl font-bold text-amber-400 mb-4 sm:mb-6 flex items-center gap-2">
                ...
                >
                  ...
                  >
                    {member.image ? (
                      ...
                      <UserCheck className="w-8 h-8 sm:w-10 sm:h-10 text-amber-400" />
                    )}
                  </div>
                  <h5 className="font-bold text-sm sm:text-base lg:text-lg text-amber-400 mb-1 sm:mb-2">
                    {member.name}
                  </h5>
                  <p
          ...
          {/* Academic Deans */}
          <div>
            <h4 className="text-lg sm:text-xl lg:text-2xl font-bold text-orange-400 mb-4 sm:mb-6 flex items-center gap-2">
              <GraduationCap className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" />
              <span>Academic Deans</span>
            </h4>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {section.content.deans.map((dean, index) => (
                ...
                >
                  ...
                  <h5 className="font-bold text-sm sm:text-base text-orange-400 mb-1 sm:mb-2">
                    {dean.name}
                  </h5>
                  <p
  ...
  return (
    ...
    >
      ...
      {/* Navigation Tabs */}
      <section className="container mx-auto px-3 sm:px-4 lg:px-6 pb-6 sm:pb-8">
        <div className="max-w-5xl mx-auto w-full">
          <div className="flex overflow-x-auto scrollbar-hide gap-2 sm:gap-3 lg:gap-4 pb-2">
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6 lg:mb-8">
              {(() => {
                ...
                return (
                  <Icon
                    className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-transparent bg-gradient-to-r flex-shrink-0"
                    style={{
