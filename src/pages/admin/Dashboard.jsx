        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px] gap-6">
                <div className="relative">
                    ...
                    <Loader className="w-16 h-16 animate-spin text-indigo-500 absolute top-0 left-0" />
                </div>
        ...
        <div className="space-y-10 animate-fade-in pb-10">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100 pb-8">
                <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Overview of system activity and management.</p>
                </div>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-6">
                {statCards.map((stat, index) => (
                    <button
                        ...
                        className="bg-white p-3 sm:p-6 rounded-xl border border-gray-100 hover:border-indigo-100 hover:shadow-lg transition-all text-left flex flex-col gap-2 sm:gap-4 group relative overflow-hidden"
                    >
                        ...
                        <div>
                            <h3 className="text-lg sm:text-3xl font-bold text-gray-900 leading-tight">{stat.value}</h3>
                            <p className="text-[9px] sm:text-xs text-gray-400 font-black uppercase tracking-tighter sm:tracking-normal mt-0.5">{stat.label}</p>
                        </div>
                    </button>
                ))}
            </div>
            ...
            <div className="w-full bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <button onClick={() => navigate('/admin/pending')} className="p-4 bg-gray-50 border border-gray-100 rounded-lg hover:bg-white hover:border-indigo-200 hover:shadow-md transition-all text-left flex flex-col gap-2">
                        <div className="flex items-center justify-between">
                            <ShieldCheck className="w-6 h-6 text-indigo-500" />
                            <ArrowRight className="w-4 h-4 text-gray-300" />
                        </div>
                        <div>
                            <h5 className="font-semibold text-gray-900">Pending Requests</h5>
                            <p className="text-xs text-gray-500 leading-relaxed">Review and approve new alumni.</p>
                        </div>
                    </button>
