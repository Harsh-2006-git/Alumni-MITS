        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-12 py-8 sm:py-12 lg:py-16 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              ...
              <h1 className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold ${isDarkMode ? "text-white" : "text-slate-900"}`}>
                MITS Mentorship
              </h1>
              <Sparkles className="w-6 h-6 sm:w-8 sm:h-8 text-cyan-400 animate-pulse" />
            </div>
    ...
    >
      ...
      {notification && (
        <div className="fixed top-20 right-4 z-[60] animate-in slide-in-from-right duration-300">
          <div
            className={`rounded-xl shadow-xl p-4 sm:p-5 max-w-sm border ${notification.type === "success"
      ...
      {loading && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[70]">
          <div
            className={`rounded-3xl p-8 shadow-xl border ${isDarkMode
              ? "bg-slate-900 border-slate-800"
              : "bg-white border-slate-200"
              }`}
          >
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-12 py-8 sm:py-12 lg:py-16 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className={`text-base sm:text-xl lg:text-2xl mb-3 sm:mb-4 font-semibold ${isDarkMode ? "text-blue-400" : "text-blue-600"}`}>
      ...
      <section className="container mx-auto px-4 sm:px-6 pb-12 sm:pb-16">
        <div className="max-w-7xl mx-auto">
          <div
            className={`rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 border shadow-lg ${isDarkMode
              ? "bg-slate-900 border-slate-800"
              : "bg-white border-slate-200"
              }`}
          >
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="flex flex-col lg:flex-row items-start justify-between gap-4 sm:gap-6">
                  <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 w-full lg:w-auto">
                    <img
                      ...
                      className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl object-cover border border-slate-200 dark:border-slate-800 shadow-md"
                    />
                    <div className="flex-1">
                      <h2
                        className={`text-xl sm:text-2xl font-bold ${isDarkMode ? "text-gray-200" : "text-gray-900"
                          }`}
                      >
                      ...
                      <div className="flex flex-wrap items-center gap-3 sm:gap-4 mt-2 text-xs sm:text-sm">
                        ...
                        <span
                          className={`flex items-center gap-1 font-medium ${myMentorProfile.available
                            ? "text-green-400"
                            : "text-red-400"
                            }`}
                        >
                  ...
                  <button
                    onClick={openMentorForm}
                    className="w-full lg:w-auto flex items-center justify-center gap-2 bg-blue-600 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold hover:bg-blue-700 transition-all text-sm sm:text-base border border-blue-700 shadow-sm"
                  >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    <div>
                      <h3 className={`text-base sm:text-lg font-semibold mb-3 ${isDarkMode ? "text-blue-400" : "text-blue-600"}`}>
                        Expertise
                      </h3>
                      <p
                        className={`rounded-xl p-3 sm:p-4 text-xs sm:text-sm ${isDarkMode
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {myMentorProfile.topics.map((topic, index) => (
                          <span
                            key={index}
                            className={`px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg font-medium border text-xs sm:text-sm ${isDarkMode
                    ...
                    <div className="space-y-2 sm:space-y-3">
                      {Object.entries(myMentorProfile.availability).map(
                        ([day, slots]) => (
                          <div
                            key={day}
                            className={`flex flex-col sm:flex-row sm:items-center justify-between p-3 sm:p-4 rounded-xl gap-2 ${isDarkMode ? "bg-slate-800/50" : "bg-gray-100"
                              }`}
                          >
                            <span
                              className={`font-medium capitalize text-sm sm:text-base ${isDarkMode ? "text-gray-200" : "text-gray-800"
                                }`}
                            >
                            ...
                            <div className="flex flex-wrap gap-2">
                              {slots.map((slot, index) => (
                                <span
                                  key={index}
                                  className={`px-2 sm:px-3 py-1 rounded text-xs sm:text-sm border ${isDarkMode
      ...
      {showMentorForm && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="max-w-2xl w-full max-h-[90vh] flex flex-col">
            <div
              className={`rounded-2xl sm:rounded-3xl shadow-2xl flex flex-col max-h-full overflow-hidden border ${isDarkMode
                ? "bg-slate-900 border-slate-800"
                : "bg-white border-slate-200"
                }`}
            >
              <div
                className={`p-4 sm:p-6 border-b flex-shrink-0 ${isDarkMode
                  ? "border-slate-800 bg-slate-900"
                  : "border-slate-200 bg-white"
                  }`}
              >
                <div className="flex items-center justify-between">
                  <h2 className={`text-xl sm:text-2xl font-bold ${isDarkMode ? "text-blue-400" : "text-blue-600"}`}>
                    {myMentorProfile
                      ? "Edit Mentor Profile"
                      : "Create Mentor Profile"}
                  </h2>
              ...
              <div className="overflow-y-auto flex-1">
                ...
                >
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl border-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm sm:text-base ${isDarkMode
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <textarea
                        ...
                        className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl border-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all h-20 sm:h-24 text-sm sm:text-base ${isDarkMode
                          ? "bg-slate-800/50 border-blue-500/30 text-white"
                          : "bg-white border-blue-300 text-gray-900"
                          }`}
                    ...
                    <div className="sm:col-span-2">
                      ...
                      />
                      <p
                        className={`text-xs sm:text-sm mt-1 ${isDarkMode ? "text-gray-400" : "text-gray-500"
                          }`}
                      >
                          ...
                          ([day, slots]) => (
                            ...
                            >
                              <div className="flex items-center justify-between mb-2">
                                <span
                                  className={`text-sm font-semibold capitalize ${isDarkMode
                                    ? "text-gray-200"
                                    : "text-gray-800"
                                    }`}
                                >
                                ...
                                {slots.map((slot, index) => (
                                  ...
                                  >
                                    <input
                                      ...
                                      className={`flex-1 px-2 py-1.5 rounded border text-xs ${isDarkMode
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl border focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm sm:text-base ${isDarkMode
                    ...
                    <div className="flex items-center">
                      <label
                        className={`flex items-center gap-3 text-sm font-medium ${isDarkMode ? "text-gray-300" : "text-gray-700"
                          }`}
                      >
                        <input
                          type="checkbox"
                  ...
                  <div
                    className={`flex flex-col sm:flex-row gap-3 pt-4 sm:pt-6 border-t ${isDarkMode ? "border-slate-800" : "border-slate-200"
                      }`}
                  >
                    <button
                      type="button"
                      onClick={() => setShowMentorForm(false)}
                      className={`flex-1 px-4 sm:px-6 py-2.5 sm:py-3 border rounded-lg sm:rounded-xl transition-colors font-medium text-sm sm:text-base ${isDarkMode
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="flex-1 bg-blue-600 text-white py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold hover:bg-blue-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md text-sm sm:text-base"
                    >
                      {loading ? (
